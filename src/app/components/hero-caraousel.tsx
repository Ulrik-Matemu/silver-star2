...
const slides = [
  {
    ...
    description: "Petal by petal, we cultivate global innovation. Our roots run deep in excellence, ensuring your career branches out into sunlit opportunities. Join a garden of thinkers where every idea is nurtured to full perennial bloom.",
    buttonText: "LEARN MORE",
    image: "https://via.placeholder.com/1920x600?text=Slide+1+Background"
  },
  {
    title: "Innovate with us",
    description: "Petal by petal, we cultivate global innovation. Our roots run deep in excellence, ensuring your career branches out into sunlit opportunities. Join a garden of thinkers where every idea is nurtured to full perennial bloom.",
    buttonText: "EXPLORE CAREERS",
    image: "https://via.placeholder.com/1920x600?text=Slide+2+Background"
  }
];
      ...
      >
        {slides.map((slide, index) => (
          <div 
            ...
            className="min-w-full h-full bg-cover bg-center flex items-center px-14 md:px-24 lg:px-38"
            style={{ backgroundImage: `url(${slide.image})` }}
          >
            {/* Text Content */}
            <div className="max-w-5xl animate-fadeIn mt-[-40px] md:mt-0">
              ...
              <p className="text-sm md:text-lg text-gray-600 font-bold mb-6 md:mb-8 leading-relaxed">
                {slide.description}
              </p>
              <div className='w-full h-[1px] bg-black mb-6 md:mb-8'></div>
