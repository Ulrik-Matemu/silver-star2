...
const products: Product[] = [
  ...
  { title: "Sports Flooring", category: "sports-flooring", image: "/products/product5.jpeg", accentColor: "bg-rose-500" },
];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {products.map((item, index) => (
            <a href={`/products/${item.category.toLowerCase()}`} key={index} className="block">
              <div
                key={index}
